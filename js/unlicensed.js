function renderUnlicensedCharts(data) {
    ...
    generateUnAgeDonut(unData); 
    generateUnJurisdictionBar(unData); 
    generateUnLineChart(unData);
}
...
function generateUnAgeDonut(data) {
    ...
    // FIX: Add selection tracking state
    ...
    function highlight(dL, dV, isClick = false) {
        // Prevent random hovers from wiping out a locked click state
    ...
    // Attach event listeners safely prior to the animation starting
